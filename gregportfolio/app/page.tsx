        ...
        <div className="z-10 w-full max-w-5xl flex flex-col md:flex-row gap-16 items-center justify-between">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="mt-10 flex flex-col gap-3 text-sm text-white/60">
                <a href="tel:+33600000000" className="flex items-center gap-3 hover:text-white transition-colors text-base">
                  <span className="text-red-500 text-lg">✆</span>
                  <span className="font-mono tracking-widest">+33 7 69 29 42 68</span>
                </a>
                <a href="mailto:contact@venox.fr" className="flex items-center gap-3 hover:text-white transition-colors text-base">
                  <span className="text-red-600 text-lg">✉</span>
                  <span className="font-mono tracking-widest">gregoiretrotin@gmail.com</span>
                </a>
                <a href="https://www.instagram.com/venox.visuals" target="_blank" className="flex items-center gap-3 hover:text-white transition-colors">
                  <svg className="text-red-500 w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="font-mono tracking-widest">Instagram "venox.visuals"</span>
                </a>
              </div>
            </div>
